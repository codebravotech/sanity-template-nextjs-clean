...
export const callToAction = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'image',
      description:
        'You can either provide an image or a video, but not both. To provide a video, clear this image field.',
      group: 'media',
      options: {
        hotspot: true,
      },
    ...
    defineField({
      ...
      title: 'Video',
      description:
        'You can either provide an image or a video, but not both. To provide an image, clear the video field.',
      // @ts-ignore
      group: 'media',
      hidden: ({parent}) => {
        return !!parent?.image
    ...
    prepare(selection) {
      ...
      return {
        ...
        media: image
          ? image
          : playbackId
            ? videoPreviewImage({posterUrl, title, filename: originalFilename})
            : undefined,
      }
    },
  },
